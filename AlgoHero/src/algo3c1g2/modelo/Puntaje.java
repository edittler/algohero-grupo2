...
public class Puntaje implements Posicionable {
	...
	public boolean contarPuntos(double instante, char tecla){
		...
		//Le resta el tiempo entre que se mostro por primera vez el circulito hasta que llega al rango de habilitacion
		//Y obtiene el instante actual de la reproduccion 
		instante-=TIEMPO_ENTRE_MENSAJE_Y_ACCION; //esto es equivalente a poner instante=instante-TIEMPO_ENTRE_MENSAJE_Y_ACCION TODO borren este comentario
		...
		if(!(this.yaFueContado(instante))){
			...
			/*Esto significa que si acerto le suma PUNTOS a this.puntos y sino le suma 0  TODO despues borren este comentario*/
